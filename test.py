...
def get_command_line_parser():
    ...
    # about pre-training
    parser.add_argument('-epochs_pretrain', type=int, default=1000)
    parser.add_argument('-epochs_new', type=int, default=5)
    parser.add_argument('-lr_pretrain', type=float, default=0.1)
    ...
    parser.add_argument('-loss_iter', type=int, default=150)
    parser.add_argument('-balance', type=int, default=0.01)
